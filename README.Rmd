...
We make use of the custom macro **[TODO: CIMR 002]**, which can be found in the repository [CitaviRMacros](https://github.com/SchmidtPaul/CitaviRMacros) to allow for an easier download.
