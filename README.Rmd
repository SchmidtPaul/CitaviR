...
This is a small example showing an entire work flow from start to finish.
...
make sure all relevant columns are selected (e.g. via making use of Citavi's [customizable selection presets](https://www1.citavi.com/sub/manual6/en/index.html?referencegridformworkspaceeditor.html)) and export to an Excel file.
