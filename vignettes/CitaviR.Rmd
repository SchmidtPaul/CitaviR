...
knitr::include_graphics("Citavi_Table.png")
```
...
knitr::include_graphics("Citavi_TableToExcel.png")
```
...
knitr::include_graphics("Excel_files_out.png")
```
...
<!-- ```{r, echo=FALSE, out.width = "100%"} -->
<!-- knitr::include_graphics("https://github.com/SchmidtPaul/CitaviRMacros/blob/main/CIMR%20Import/CIMR%20002%20-%20Import%20handle_obvious_dup%20info/CIMR%20002.gif?raw=true") -->
<!-- ``` -->
